...
Original file is located at
    https://colab.research.google.com/drive/1BP3Drw3pmNfeZjfGb74wOEAe1iIuCKAu
"""

!pip install -q streamlit

import urllib
print("Copie este número (Senha do Localtunnel):", urllib.request.urlopen('https://ipv4.icanhazip.com').read().decode('utf8').strip("\n"))
...
!streamlit run dashboard.py --server.enableCORS false --server.enableXsrfProtection false &>/content/logs.txt &
!npx localtunnel --port 8501